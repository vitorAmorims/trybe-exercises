...
function isManager(id) {
    // return employees.find(employee => employee.id === id); procura por id
    
    //retonando [[ com ids dos gerentes]]
    // const managers = employees.map(employee => employee.managers)
    // console.log(managers);

    //converti o array para strings
    const managers = employees.map(employee => employee.managers).toString()
    // console.log(managers);

    //aqui, o método includes vai procurar dentro a variável managers o id
