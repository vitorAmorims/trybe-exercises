...
// console.log(employeeByName()); output {}

// etapa 3.2
function employeeBy2(firstName) {
    return employees.find(employee => employee.firstName === firstName);
}
// console.log(employeeBy2('Nigel')) output obj complete de firstName Niguel

// etapa 3.3
function employeeBy3(lastName) {
    return employees.find(employee => employee.lastName === lastName)
}
// console.log(employeeBy3('Nelson')); output obj complete de lastName Nelson

// etapa completa, 
function employeeByName4(employeeName) {
    if (!employeeName) {
        return {}
    } else {
...
console.log(employeeByName4('Orloff')) 