...
//quero pesquisar um objeto do meu array, cujo nome começa: ...
const nameShip = name => name === "Yamato"
const filterShips = (ships) => ships.filter(
    ({name, length, measurementUnit = 'meters'}) => nameShip(name) 
)
console.log(filterShips(ships))
