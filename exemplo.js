...
for (let i in estudantes) {
    if (estudantes[i].turno === 'Manhã') {
        nomeCompleto.push(estudantes[i].nome + ' '+ estudantes[i].sobrenome);
    }
}
...
estudantes.forEach((estudante) => {
    if (estudante.turno === 'Manhã') {
        fullname.push(estudante.nome + ' ' + estudante.sobrenome);
    }
});
// console.log(fullname);

const estudantesmanha = estudantes.filter((estudante) => (
